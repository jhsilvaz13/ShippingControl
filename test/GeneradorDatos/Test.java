    ...
    public static void RegitrarEmbarcaciones(Long n) {
        ...
        try {
            for (long i = 0; i < n; i++) {
                ...
                registrar.println(String.valueOf(String.format("%07d", i)) + "," + "Test" + "," + "Test" + "," + String.valueOf(random.nextInt(7)) + "," + String.valueOf(random.nextInt(100)+400) + ","
                        + String.valueOf(random.nextInt(301)+100) + "," + String.valueOf(random.nextInt(2)));
                registrar.close();
            }
        } catch (Exception e) {
